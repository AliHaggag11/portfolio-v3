    ...
    <div className="py-32 md:py-48 lg:py-60 relative z-10 overflow-x-clip">
      ...
      <div className="container relative z-20">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          <a
            href="#projects" // Updated href to scroll to the projects section
            className="inline-flex items-center gap-2 border border-white/15 px-6 h-12 rounded-xl hover:-rotate-3 transition duration-300"
          >
            <span className="font-semibold">Explore My Work</span>
            <ArrowDown className="size-4" />
          </a>
          {/* Changed button to an anchor tag for WhatsApp link with animation */}
          <a
            href="https://wa.me/201111650444" // Replace with your actual WhatsApp number
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 border-white bg-white text-gray-900 h-12 px-6 rounded-xl hover:-rotate-3 transition duration-300"
          >
            <span>🤝</span>

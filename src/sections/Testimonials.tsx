...
const testimonials = [
  {
    name: "Seif Hanno",
    position: "Marketing Manager @ NGD",
  ...
  {
    name: "Nour Ahmed",
    position: "Head of Design @ Blimey",
  ...
  {
    name: "Youssef Kattamish",
    position: "CEO @ Illujis",
  ...
  {
    name: "Malak Osama",
    position: "Product Manager @ Upscale DA",
  ...
  {
    name: "Karim Sherif",
    position: "Director of IT @ Expmed",
